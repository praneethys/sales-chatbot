...
if __name__ == '__main__':
    ...
    loader = CSVLoader(file_path='/Users/praneeth/Documents/ml/marketing-chatbot/data/pricing.csv', encoding="utf-8", csv_args={
                'delimiter': ','})
    data = loader.load()
    print(f'data: {data}')
    ...
    if input:
        ...
        output = conversation_retrieval_chain(inputs={"question": input, "chat_history": app.get_history()}, 
